...
{
    public sealed class AyaMemoryinPictureDef : CardTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(AyaMemoryinPicture);
        }
        ...
        [EntityLogic(typeof(AyaMemoryinPictureDef))]
        public sealed class AyaMemoryinPicture : Card
        {
