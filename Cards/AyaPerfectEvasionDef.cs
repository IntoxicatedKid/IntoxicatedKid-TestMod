...
{
    public sealed class AyaPerfectEvasionDef : CardTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(AyaPerfectEvasion);
        }
        ...
        [EntityLogic(typeof(AyaPerfectEvasionDef))]
        public sealed class AyaPerfectEvasion : Card
        {
