...
{
    public sealed class AyaSuspiciousIntentionDef : CardTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(AyaSuspiciousIntention);
        }
        ...
        [EntityLogic(typeof(AyaSuspiciousIntentionDef))]
        public sealed class AyaSuspiciousIntention : Card
        {
