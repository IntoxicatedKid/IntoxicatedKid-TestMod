...
{
    public sealed class AyaRuinBirdDef : CardTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(AyaRuinBird);
        }
        ...
        public override CardConfig MakeConfig()
        {
            var cardConfig = new CardConfig(
                ...
                IsXCost: false,
                Cost: new ManaGroup() { Any = 3, Black = 1 },
                UpgradedCost: null,
                MoneyCost: null,
                Damage: null,
                UpgradedDamage: null,
        ...
        [EntityLogic(typeof(AyaRuinBirdDef))]
        public sealed class AyaRuinBird : Card
        {
