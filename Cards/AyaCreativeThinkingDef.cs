...
{
    public sealed class AyaCreativeThinkingDef : CardTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(AyaCreativeThinking);
        }
        ...
        [EntityLogic(typeof(AyaCreativeThinkingDef))]
        public sealed class AyaCreativeThinking : Card
        {
